...
def log_to_txt(env_name, random_seed, init_obs, min_obs, max_obs, total_step, result, trial):
    seed = '(' + str(random_seed) + ')'
    f = open('./log/' + env_name + '_init_obs_' + str(init_obs) + '_min_obs_' + str(min_obs) + '_max_obs_' + str(max_obs) + '_seed_' + seed + '_trial_'+ str(trial) + '.txt', 'a')
