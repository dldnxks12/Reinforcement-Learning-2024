...
if __name__ == '__main__':
    ...
    parser.add_argument('--obs-delayed-steps',     default=20, type=int)
    parser.add_argument('--max-obs-delayed-steps', default=30, type=int)
    ...
    for trial in range(0, 5):
        ...
        print(f"Environment: {args.env_name}, Obs. Delayed: {args.obs_delayed_steps}, Max-Obs. Delayed: {args.max_obs_delayed_steps}, Random Seed: {trial_seed}", "\n")
