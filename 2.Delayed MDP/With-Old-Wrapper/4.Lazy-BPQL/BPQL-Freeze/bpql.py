...
class BPQLAgent:  # 5.SAC for the base learning algorithm
    def __init__(self, args, state_dim, action_dim, action_bound, action_space, device):
        ...
        self.device = device
        self.replay_memory = ReplayMemory(args.obs_delayed_steps, state_dim, action_dim, device, args.buffer_size)
        ...
        self.actor = GaussianPolicy(args, args.obs_delayed_steps, state_dim, action_dim, action_bound, args.hidden_dims, F.relu, device).to(device)
