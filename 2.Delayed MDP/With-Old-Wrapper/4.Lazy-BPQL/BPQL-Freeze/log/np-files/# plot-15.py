...
# TODO : Ant
y1 = np.load('Ant-v4_obs_5_max_obs_15_seed_(1)_trial_0.npy')
y1 = np.array([float(i) for i in y1])
y2 = np.load('Ant-v4_obs_5_max_obs_15_seed_(1)_trial_1.npy')
y2 = np.array([float(i) for i in y2])
y3 = np.load('Ant-v4_obs_5_max_obs_15_seed_(1)_trial_2.npy')
y3 = np.array([float(i) for i in y3])
y4 = np.load('Ant-v4_obs_5_max_obs_15_seed_(1)_trial_3.npy')
y4 = np.array([float(i) for i in y4])
y5 = np.load('Ant-v4_obs_5_max_obs_15_seed_(1)_trial_4.npy')
...
# TODO : HalfCheetah
y1 = np.load('HalfCheetah-v4_obs_5_max_obs_15_seed_(1)_trial_0.npy')
y1 = np.array([float(i) for i in y1])
y2 = np.load('HalfCheetah-v4_obs_5_max_obs_15_seed_(1)_trial_1.npy')
y2 = np.array([float(i) for i in y2])
y3 = np.load('HalfCheetah-v4_obs_5_max_obs_15_seed_(1)_trial_2.npy')
y3 = np.array([float(i) for i in y3])
y4 = np.load('HalfCheetah-v4_obs_5_max_obs_15_seed_(1)_trial_3.npy')
y4 = np.array([float(i) for i in y4])
y5 = np.load('HalfCheetah-v4_obs_5_max_obs_15_seed_(1)_trial_4.npy')
y5 = np.array([float(i) for i in y5])
...
# TODO : Walker2d
y1 = np.load('Walker2d-v4_obs_5_max_obs_15_seed_(1)_trial_0.npy')
y1 = np.array([float(i) for i in y1])
y2 = np.load('Walker2d-v4_obs_5_max_obs_15_seed_(1)_trial_1.npy')
y2 = np.array([float(i) for i in y2])
y3 = np.load('Walker2d-v4_obs_5_max_obs_15_seed_(1)_trial_2.npy')
y3 = np.array([float(i) for i in y3])
y4 = np.load('Walker2d-v4_obs_5_max_obs_15_seed_(1)_trial_3.npy')
y4 = np.array([float(i) for i in y4])
y5 = np.load('Walker2d-v4_obs_5_max_obs_15_seed_(1)_trial_4.npy')
y5 = np.array([float(i) for i in y5])
...
# TODO : Hopper
y1 = np.load('Hopper-v4_obs_5_max_obs_15_seed_(1)_trial_0.npy')
y1 = np.array([float(i) for i in y1])
y2 = np.load('Hopper-v4_obs_5_max_obs_15_seed_(1)_trial_1.npy')
y2 = np.array([float(i) for i in y2])
y3 = np.load('Hopper-v4_obs_5_max_obs_15_seed_(1)_trial_2.npy')
y3 = np.array([float(i) for i in y3])
y4 = np.load('Hopper-v4_obs_5_max_obs_15_seed_(1)_trial_3.npy')
y4 = np.array([float(i) for i in y4])
y5 = np.load('Hopper-v4_obs_5_max_obs_15_seed_(1)_trial_4.npy')
y5 = np.array([float(i) for i in y5])
...
# TODO : Pendulum
y1 = np.load('InvertedPendulum-v4_obs_5_max_obs_15_seed_(1)_trial_0.npy')
y1 = np.array([float(i) for i in y1])
y2 = np.load('InvertedPendulum-v4_obs_5_max_obs_15_seed_(1)_trial_1.npy')
y2 = np.array([float(i) for i in y2])
y3 = np.load('InvertedPendulum-v4_obs_5_max_obs_15_seed_(1)_trial_2.npy')
y3 = np.array([float(i) for i in y3])
y4 = np.load('InvertedPendulum-v4_obs_5_max_obs_15_seed_(1)_trial_3.npy')
y4 = np.array([float(i) for i in y4])
y5 = np.load('InvertedPendulum-v4_obs_5_max_obs_15_seed_(1)_trial_4.npy')
y5 = np.array([float(i) for i in y5])
