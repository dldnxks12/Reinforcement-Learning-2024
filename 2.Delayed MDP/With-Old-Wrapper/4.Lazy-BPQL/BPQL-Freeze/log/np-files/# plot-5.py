...
# TODO : Ant
y1 = np.load('Ant-v4_obs_3_max_obs_5_seed_(1)_trial_0.npy')
y1 = np.array([float(i) for i in y1])
y2 = np.load('Ant-v4_obs_3_max_obs_5_seed_(1)_trial_1.npy')
y2 = np.array([float(i) for i in y2])
y3 = np.load('Ant-v4_obs_3_max_obs_5_seed_(1)_trial_2.npy')
y3 = np.array([float(i) for i in y3])
y4 = np.load('Ant-v4_obs_3_max_obs_5_seed_(1)_trial_3.npy')
y4 = np.array([float(i) for i in y4])
y5 = np.load('Ant-v4_obs_3_max_obs_5_seed_(1)_trial_4.npy')
...
# TODO : HalfCheetah
y1 = np.load('HalfCheetah-v4_obs_3_max_obs_5_seed_(1)_trial_0.npy')
y1 = np.array([float(i) for i in y1])
y2 = np.load('HalfCheetah-v4_obs_3_max_obs_5_seed_(1)_trial_1.npy')
y2 = np.array([float(i) for i in y2])
y3 = np.load('HalfCheetah-v4_obs_3_max_obs_5_seed_(1)_trial_2.npy')
y3 = np.array([float(i) for i in y3])
y4 = np.load('HalfCheetah-v4_obs_3_max_obs_5_seed_(1)_trial_3.npy')
y4 = np.array([float(i) for i in y4])
y5 = np.load('HalfCheetah-v4_obs_3_max_obs_5_seed_(1)_trial_4.npy')
y5 = np.array([float(i) for i in y5])
...
# TODO : Walker2d
y1 = np.load('Walker2d-v4_obs_3_max_obs_5_seed_(1)_trial_0.npy')
y1 = np.array([float(i) for i in y1])
y2 = np.load('Walker2d-v4_obs_3_max_obs_5_seed_(1)_trial_1.npy')
y2 = np.array([float(i) for i in y2])
y3 = np.load('Walker2d-v4_obs_3_max_obs_5_seed_(1)_trial_2.npy')
y3 = np.array([float(i) for i in y3])
y4 = np.load('Walker2d-v4_obs_3_max_obs_5_seed_(1)_trial_3.npy')
y4 = np.array([float(i) for i in y4])
y5 = np.load('Walker2d-v4_obs_3_max_obs_5_seed_(1)_trial_4.npy')
y5 = np.array([float(i) for i in y5])
...
# TODO : Hopper
y1 = np.load('Hopper-v4_obs_3_max_obs_5_seed_(1)_trial_0.npy')
y1 = np.array([float(i) for i in y1])
y2 = np.load('Hopper-v4_obs_3_max_obs_5_seed_(1)_trial_1.npy')
y2 = np.array([float(i) for i in y2])
y3 = np.load('Hopper-v4_obs_3_max_obs_5_seed_(1)_trial_2.npy')
y3 = np.array([float(i) for i in y3])
y4 = np.load('Hopper-v4_obs_3_max_obs_5_seed_(1)_trial_3.npy')
y4 = np.array([float(i) for i in y4])
y5 = np.load('Hopper-v4_obs_3_max_obs_5_seed_(1)_trial_4.npy')
y5 = np.array([float(i) for i in y5])
...
# TODO : Pendulum
y1 = np.load('InvertedPendulum-v4_obs_3_max_obs_5_seed_(1)_trial_0.npy')
y1 = np.array([float(i) for i in y1])
y2 = np.load('InvertedPendulum-v4_obs_3_max_obs_5_seed_(1)_trial_1.npy')
y2 = np.array([float(i) for i in y2])
y3 = np.load('InvertedPendulum-v4_obs_3_max_obs_5_seed_(1)_trial_2.npy')
y3 = np.array([float(i) for i in y3])
y4 = np.load('InvertedPendulum-v4_obs_3_max_obs_5_seed_(1)_trial_3.npy')
y4 = np.array([float(i) for i in y4])
y5 = np.load('InvertedPendulum-v4_obs_3_max_obs_5_seed_(1)_trial_4.npy')
y5 = np.array([float(i) for i in y5])
...
# TODO : cheetah
axes[0, 0].plot(x_length, LA_Ant_mean, linestyle = '-', color = 'tab:brown', label = 'F-BPQL')
axes[0, 0].fill_between(x_length, LA_Ant_mean+LA_Ant_std, LA_Ant_mean-LA_Ant_std, color = 'tab:brown', alpha = 0.1)
axes[0, 1].plot(x_length, LA_HalfCheetah_mean, linestyle = '-', color = 'tab:brown', label = 'F-BPQL')
...
axes[0, 2].plot(x_length, LA_Hopper_mean, linestyle = '-', color = 'tab:brown', label = 'F-BPQL')
axes[0, 2].fill_between(x_length, LA_Hopper_mean+LA_Hopper_std, LA_Hopper_mean-LA_Hopper_std, color = 'tab:brown', alpha = 0.1)
axes[1, 0].plot(x_length, LA_Walker2d_mean, linestyle = '-', color = 'tab:brown', label = 'F-BPQL')
...
axes[1, 1].plot(x_length, LA_InvertedPendulum_mean, linestyle = '-', color = 'tab:brown', label = 'F-BPQL')
