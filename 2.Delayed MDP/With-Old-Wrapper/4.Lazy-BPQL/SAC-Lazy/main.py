import argparse
import torch
from augmented_sac import BPQLAgent
...
if __name__ == '__main__':
    ...
    parser.add_argument('--obs-delayed-steps', default=5, type=int)  # Delayed timesteps (Observation, Reward)
    parser.add_argument('--act-delayed-steps', default=0, type=int)  # Delayed timesteps (Action)
