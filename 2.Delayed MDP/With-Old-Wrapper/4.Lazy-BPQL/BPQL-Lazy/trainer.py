...
"""
Training    : Constant delay O_max 
Evaluation : Random delay in [O_min, O_max]
"""
...
class Trainer:
    def __init__(self, env, eval_env, agent, trial, args):
        ...
        self.max_delayed_steps = args.obs_delayed_steps
    ...
    def train(self):
        ...
        while not self.finish_flag:
            ...
            while not done:
                ...
                if self.local_step < self.max_delayed_steps:  # if t < d
                ...
                elif self.local_step == self.max_delayed_steps:  # if t == d
                    ...
                    first_action_idx = len(self.agent.temporary_buffer.actions) - self.max_delayed_steps
                    ...
                    if self.local_step > 2 * self.max_delayed_steps:  # if t > 2d
    ...
    def evaluate(self):
        # TODO : Evaluate agent in randomly changing env. delay = [O_min, O_max]
        # TODO : Tagging delayed time-steps in State information
        self.eval_num += 1
        reward_list = []
        ...
        for epi in range(self.eval_episode):
            ...
            while not done:
                ...
                if self.eval_local_step < self.max_delayed_steps:
                ...
                elif self.eval_local_step == self.max_delayed_steps:
                    ...
                    if self.eval_local_step < last_observed_delay + state_tag:
                        ...
                        first_action_idx = len(self.agent.eval_temporary_buffer.actions) - self.max_delayed_steps
        ...
        log_to_txt(self.args.env_name, self.args.random_seed,  self.max_delayed_steps, self.max_obs_delayed_steps, self.total_step, sum(reward_list) / len(reward_list), self.trial)
